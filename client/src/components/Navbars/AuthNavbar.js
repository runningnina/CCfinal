          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                ...
                >
                  <i class="fas fa-solid fa-building"></i> Companies
                </button>
              </li>
              ...
              <li className="flex items-center">
                ...
                >
                  <i class="fas fa-solid fa-calendar"></i> Events
                </button>
              </li>
              ...
              <li className="flex items-center">
                ...
                >
                  <i class="fas fa-solid fa-pen"></i> Blogs
                </button>
              </li>
              ...
              <li className="flex items-center">
                <button
                  ...
                  type="button" onClick={() => changeRoute(0)}
                >
                  <i class="fas fa-solid fa-key"></i> Login
                </button>
              </li>
              ...
              <li className="flex items-center">
                ...
                >
                  <i class="fas fa-solid fa-user-plus"></i> Signup
                </button>
              </li>
